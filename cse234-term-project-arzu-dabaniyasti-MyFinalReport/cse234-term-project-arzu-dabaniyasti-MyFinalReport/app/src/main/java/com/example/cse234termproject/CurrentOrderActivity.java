...
import com.example.cse234termproject.Adapters.CurrentOrderAdapter;
...
public class CurrentOrderActivity extends AppCompatActivity {
    ...
    CurrentOrderAdapter orderAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recyclerView= findViewById(R.id.currentOrder_listview);
        ...
        databaseReference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                orderAdapter=new CurrentOrderAdapter(getApplicationContext(),orderDateList,orderPriceList,orderTimeList,productNameList,quantityList,productNameCountList,productQuantityCountList);
